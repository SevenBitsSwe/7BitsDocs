...
\endhead
\hline
1.0.1 & 2025-03-8 & Giovanni Cristellon & Manuel Gusella & Redazione settimo sprint$_G$ \ref{settimo-sprint$_G$}\\
\hline
...
Nonostante queste difficoltà, il gruppo è riuscito ad affrontare la prima fase della Revisione Tecnica di Baseline$_G$ (RTB) secondo i piani, garantendo il rispetto degli obiettivi prefissati. La pianificazione dello sprint$_G$ ha tenuto conto delle possibili limitazioni, consentendo di distribuire adeguatamente le attività e assicurare la consegna della documentazione$_G$ richiesta.
    ...
    \label{settimo-sprint$_G$}
        ...
        \begin{tabular}{ l l }
            Inizio: & 2025-02-21 \\
            Fine Prevista: & 2025-03-07 \\
            Fine Effettiva: & 2025-03-07 \\
            Giorni di ritardo: & 0 \\
        \end{tabular}
        \end{table}
        \vspace{-2em}
        ...
        Nel corso del settimo sprint$_G$ il gruppo si propone di ultimare la consegna RTB$_G$ e di procedere con la fase di progettazione e sviluppo del MVP$_G$
        \\
        Il gruppo ha in programma di:
        \begin{itemize}
    ...
    Nonostante queste difficoltà, il gruppo è riuscito ad affrontare la prima fase della Revisione Tecnica di Baseline$_G$ (RTB) secondo i piani, garantendo il rispetto degli obiettivi prefissati. La pianificazione dello sprint$_G$ ha tenuto conto delle possibili limitazioni, consentendo di distribuire adeguatamente le attività e assicurare la consegna della documentazione$_G$ richiesta.
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                \pie[
                    ...
                    radius=1.5
                ]{8/Responsabile - 8\%, 2/Amministratore - 2\%, 22/Verificatore - 22\%, 38/Progettista - 38\%, 30/Programmatore - 30\%}
            \end{tikzpicture}
        ...
        Durante il settimo periodo si è conclusa la revisione RTB$_G$ con il professor Vardanega, ottenendo un esito positivo.
        L’obiettivo del prossimo sprint$_G$ sarà proseguire la progettazione, predisporre l'infrastruttura per l'esecuzione automatica dei test e la scrittura di parte del codice.
