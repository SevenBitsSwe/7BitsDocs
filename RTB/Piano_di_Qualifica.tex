...
\listoftables %lista delle tabelle presenti nel docuemnto
\newpage
\begin{justify}
...
In seguito sono presenti le metriche che il gruppo si impegna a soddisfare per la qualità del prodotto software.
...
\begin{tabular}{|c|c|c|c|}
  ...
  \hline
  & Requisiti Opzionali Soddisfatti & $\geq$0\% & ? \\
  \hline
\end{tabular}
