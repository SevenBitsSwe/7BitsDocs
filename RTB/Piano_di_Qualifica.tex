...
\endhead
    \hline
    0.4.8 & 2025-02-18 & Trolese Leonardo & Pivetta Federico & Aggiunta ulteriori grafici sulle metriche del \hyperref[sec:cruscotto]{cruscotto di valutazione}\\
    \hline
    0.4.7 & 2025-02-16 & Trolese Leonardo & Pivetta Federico & Aggiunta ulteriori grafici sulle metriche del \hyperref[sec:cruscotto]{cruscotto di valutazione}\\
    \hline
    0.4.6 & 2025-02-15 & Trolese Leonardo & Pivetta Federico & Aggiunta grafici sulle metriche del \hyperref[sec:cruscotto]{cruscotto di valutazione}\\ 
    \hline
...
\begin{tabular}{|c|c|c|c|}
  ...
  \hline
  MPC17 & Efficienza temporale (ET) & $\geq$ 0.2 & $\geq$ 1.0 \\
  \hline
\end{tabular}
...
I test di sistema servono a verificare la completa copertura dei requisiti concordati nel documento \textit{Analisi dei Requisiti v1.0.0}.\\
...
\textbf{RTB}: La metrica rappresentano un indice della qualità della documentazione e fa riferimento appunto al numero di errori ortografici individuati in fase di verifica 
...
redatti per cui si è scelto di misurarlo; con alcune eccezioni per il documento \textit{Analisi dei Requisiti v1.0.0} (nel quarto periodo), e per il documento 
\textit{Norme di Progetto v1.0.0} (nella prima e nella terza iterazione).\\
...
Un'ultima nota va aggiunta per specificare che il gruppo ha scelto di considerare la metrica relativa all'indice di Gulpease, che sia applica a cinque documenti distinti, come 
