...
\newcommand\version{0.4.5} %aggiunta versione come variabile
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.6\linewidth]{EAC.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.6\linewidth]{EV-PV.png}
  \caption{Grafico a linee della metriche EV e PV}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.6\linewidth]{AC-ETC.png}
  \caption{Grafico a linee della metriche AC e ETC}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.6\linewidth]{CV-SV.png}
  \caption{Grafico a linee della metriche CV e SV}
