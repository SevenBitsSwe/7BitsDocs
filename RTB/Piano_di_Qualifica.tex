...
\begin{tabular}{|c|c|c|c|}
  ...
  \textbf{Metrica} & \textbf{Descrizione} & \textbf{Valore accettazione} & \textbf{Valore ideale}\\
  \hline
  MPD12 & Facilità di utilizzo & $\geq$5 errori nell'interagire & $\geq$3 errori nell'interagire  \\
  \hline
  MPD13 & Tempo medio di apprendimento & $\geq$15 secondi & $\geq$5 secondi \\
  \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|}
  ...
  \textbf{Metrica} & \textbf{Descrizione} & \textbf{Valore accettazione} & \textbf{Valore ideale}\\
  \hline
  MPD14 & Complessità ciclomatica & $\geq$20 & $\geq$10 \\
  \hline
  MPD15 & Coefficiente di accoppiamento fra classi & $\geq$10 & $\geq$5 \\
  \hline
  MPD16 & Linee di codice per metodo & $\geq$50 & $\geq$25 \\
  \hline
  MPD17 & Parametri per metodo & $\geq$7 & $\geq$4 \\
  \hline
  MPD18 & Attributi per classe & $\geq$7 & $\geq$5 \\
  \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|}
  ...
  \textbf{Metrica} & \textbf{Descrizione} & \textbf{Valore accettazione} & \textbf{Valore ideale}\\
  \hline
  MPC04 & Coefficiente di accoppiamento fra classi & $\geq$10 & $\geq$5 \\
  \hline
  MPC05 & Facilità di utilizzo & $\geq$5 errori nell'interagire & $\geq$3 errori nell'interagire  \\
  \hline
  MPC06 & Tempo medio di apprendimento & $\geq$15 secondi & $\geq$5 secondi \\
  \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|}
  ...
  \textbf{Metrica} & \textbf{Descrizione} & \textbf{Valore accettazione} & \textbf{Valore ideale}\\
  \hline
  MPC26 & Rischi non previsti & $\geq$3 & 0 \\
  \hline
  MPC27 & Efficienza temporale (ET) & $\geq$3 & $\geq$1 \\
  \hline
\end{tabular}
