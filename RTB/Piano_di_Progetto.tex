...
\label{terzo-sprint$_G$}
    ...
    Il terzo sprint ha consentito al gruppo di acquisire una maggiore familiarità con le nuove tecnologie, analizzandone sia i vantaggi sia gli svantaggi associati ad ognuna di esse.\\
    ...
    Il ricevimento con il professor Riccardo Cardin è stato determinante per comprendere come redigere un documento di analisi dei requisiti il più corretto possibile e in grado di apportare un valore aggiunto al progetto; inoltre, ha permesso di risolvere un dubbio relativo agli attori nei casi d'uso.\\
