...
\endhead
\hline
0.4.7 & 2025-01-29 & Riccardo Piva & Federico Pivetta & Piccole correzioni quinto sprint \ref{quinto-sprint$_G$}\\
\hline
...
\label{quinto-sprint$_G$}
    ...
    Nel corso del quinto sprint il gruppo si propone di ultimare la redazione della documentazione per la consegna RTB prevista inizialmente per il periodo 2025-01-22 - 2025-01-24.
    In particolare si prevede il completamente di documenti come il piano di qualifica e l'analisi dei requisiti.\\
    Inoltre il gruppo:
    \begin{itemize}
    ...
    \end{itemize}
    Le attività previste sono poche e molto concentrate, inoltre questo sprint sarà quello più colpito dal periodo di esami universitari e di conseguenza sarà anche più lungo.\\
    ...
    Di conseguenza il gruppo, data la riduzione di produttività ha deciso di allungare lo sprint di una settimana e posticipare la consegna RTB al prossimo sprint.
    ...
    Inoltre, il periodo degli esami universitari ha significativamente ridotto la disponibilità dei membri del gruppo, rallentando il progresso complessivo. 
