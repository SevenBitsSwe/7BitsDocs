...
Nonostante queste difficoltà, il gruppo è riuscito ad affrontare la prima fase della Revisione Tecnica di Baseline$_G$ (RTB) secondo i piani, garantendo il rispetto degli obiettivi prefissati. La pianificazione dello sprint$_G$ ha tenuto conto delle possibili limitazioni, consentendo di distribuire adeguatamente le attività e assicurare la consegna della documentazione$_G$ richiesta.
    ...
    \label{settimo-sprint$_G$}
        ...
        \item [-] Automatizzazione dell'esecuzione dei test$_G$ di unità in un ottica di CI;
        ...
        Durante il settimo periodo il gruppo ha affrontato il colloquio RTB$_G$ con il professor Vardanega, ottenendo un esito positivo; e ha inoltre avuto modo di 
        ...
        Il valore totale attualmente stimato per il completamento del progetto è di 12.554,70€ (contro i 12.950,00€ preventivati); e di questi 4.867,20€ sono la stima delle spese
        ancora da sostenere per il completamento del prodotto e della documentazione relativa.\\
        Questo è un indicatore positivo per il gruppo, che può quindi programmare la consegna PB del progetto indicativamente per la data 2025-04-04.\\
