...
I documenti seguono due workflow distinti a seconda che si tratti di verbali (interni o esterni) oppure di documenti più corposi, e le versioni delle modifiche successive apportate ai documenti seguono il sistema di versionamento indicato di seguito.\\
    ...
    \begin{enumerate}
        ...
        \item Creazione di una pull-request$_G$ dal branch$_G$ \framebox{Verbali} al \textit{branch}$_G$ \framebox{Main};
        ...
        chiude la pull-request$_G$ ed esegue il merge$_G$ nel branch$_G$ \framebox{Main};
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Creazione di una draft pull request dal branch$_G$ corrispondente a tale documento al branch$_G$ \framebox{Main};
        \item Compilazione dei campi della sezione \textit{Registro modifiche};
        ...
        \item Quando il documento è completo l'ultimo verificatore 
        chiude la draft pull request ed esegue il merge$_G$ nel branch$_G$ \framebox{Main}, dopodiché si procede ad eliminare il branch$_G$ dedicato;
    \end{enumerate}
