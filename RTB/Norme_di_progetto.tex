...
Lo standard non entra mai nel merito del "cosa" fa il software, ma definisce il "come" opera nel contesto della qualità.
    ...
    \end{itemize}
        ...
        Misura quanto intuitivo, soddisfacente da usare e user-friendly è un software. Si compone di cinque sotto-caratteristiche:
        \begin{itemize}
        ...
        del sistema software che del suo uso delle risorse fisiche disponibili. Questo aspetto si puù ulteriormente dividere in tre sotto-caratteristiche:
        \begin{itemize}
            \item Time behavior - è indicatore di quanto velocemente un sistema puù eseguire un compito o processare una richiesta;
        ...
        software) abbiano accesso alle sole informazioni che è loro consentito visualizzare secondo il livello di autorizzazione che possiedono. Include:
        \begin{itemize}
