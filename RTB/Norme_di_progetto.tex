...
\newcommand\version{0.5.13} %aggiunta versione come variabile
    ...
    \label{analisi}
        ...
        \begin{table}[H]
          ...
          \begin{tabular}{|c|c|}
            ...
            \hline
            MPD01 & Requisiti Desiderabili Soddisfatti\\
            \hline
            MPD01 & Requisiti Opzionali Soddisfatti\\
            \hline
          \end{tabular}
    ...
    \label{progettazione}
        ...
        \begin{table}[H]
          ...
          \begin{tabular}{|c|c|}
            ...
            \textbf{Metrica} & \textbf{Descrizione} \\
            \hline
            MPD01 & Utilizzo risorse\\
            \hline
            MPD01 & Tempo medio di risposta\\
            \hline
            MPD01 & Facilità di utilizzo\\
            \hline
            MPD01 & Tempo medio di apprendimento\\
            \hline
            MPD01 & Versioni browser supportati\\
            \hline
          \end{tabular}
    ...
    \label{codifica}
        ...
        \begin{table}[H]
          ...
          \begin{tabular}{|c|c|}
            ...
            \textbf{Metrica} & \textbf{Descrizione} \\
            \hline
            MPD01 & Statement coverage\\
            \hline
            MPD01 & Branch coverage\\
            \hline
            MPD01 & Condition coverage\\
            \hline
            MPD01 & Linee di codice per metodo\\
            \hline
            MPD01 & Parametri per metodo\\
            \hline
          \end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{MPD09 - Indice Gulpease}:
    \begin{itemize}
    ...
    \item \textbf{MPD10 - Correttezza ortografica}:
    \begin{itemize}
...
\begin{itemize}
    \item \textbf{MPD11 - Utilizzo Risorse}:
    \begin{itemize}
        \item \textbf{Descrizione}: efficienza del sistema nell'uso delle risorse.
    \end{itemize}
    \item \textbf{MPD12 - Tempo medio di risposta}:
    \begin{itemize}
...
\begin{itemize}
    \item \textbf{MPD15 - Complessità ciclomatica}:
    \begin{itemize}
    ...
    \item \textbf{MPD20 - Structure Fan IN}:
      ...
      \end{itemize}
    \item \textbf{MPD21 - Structure Fan OUT}:
      \begin{itemize}
...
\subsubsection{Portabilità}
  \begin{itemize}
    \item \textbf{MPD22 - Versioni browser supportati}:
      \begin{itemize}
