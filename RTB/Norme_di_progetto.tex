...
\newpage
\section{Standard ISO/IEC:25010 "System and software quality models"}
...
Lo standard non entra mai nel merito del "cosa" fa il software, ma definisce il "come" opera nel contesto della qualità.
    ...
    \end{itemize}
        ...
        \subsubsection{Idoneità funzionale}
        Misura quanto il software soddisfa i requisiti funzionali espliciti e impliciti. Include tre sotto-caratteristiche:
        \begin{itemize}
            \item Completezza funzionale - il software deve mettere a disposizione tutte le funzionalità necessarie;
            \item correttezza funzionale - il software deve eseguire le sue funzionalità correttamente e nel modo previsto;
            \item Adeguatezza funzionale - il software deve offrire funzionalità appropriate agli obiettivi;
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \item Disponibilità - misura la frequenza con la quale il software è "up-and-running";
            \item Tolleranza agli errori - rappresenta la capacità del software di funzionare anche in presenza di errori;
            \item Recuperabilità - rappresenta la capacita del software di recuperare da un failure riprendendo le sue funzioni;
        \end{itemize}

        \subsubsection{Usabilità}
        Misura quanto intuitivo, soddisfacente da usare e user-friendly è un software. Include quattro sotto-caratteristiche:
        \begin{itemize}
            \item Understandability - rappresenta la facilità con cui gli utenti possono capire le funzionalità di un software e farne uso;
