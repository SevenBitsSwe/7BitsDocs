...
\begin{itemize}
    ...
    \item \textbf{MPD05 - Statement Coverage}: percentuale di istruzioni eseguite durante i test.
...
\begin{itemize}
    \item \textbf{MPC18 - Indice Gulpease}: misura la leggibilità di un documento in italiano:
    \[
    ...
    \end{itemize}
    \item \textbf{MPC19 - Correttezza ortografica}: numero di errori ortografici in un documento.
\end{itemize}
