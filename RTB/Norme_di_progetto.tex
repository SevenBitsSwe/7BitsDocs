...
\newcommand\version{0.5.7} %aggiunta versione come variabile
...
\section{Processi di supporto}
    ...
    Il suo scopo è quello di gestire e organizzare ogni modifica sul codice o sulla documentazione supportando con delle motivazioni alla base dei cambiamenti effettuati e con gli autori relativi
