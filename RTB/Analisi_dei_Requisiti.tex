...
\hline
0.3.0 & 2025-01-4 & Uncas Peruzzi & Riccardo Piva & Refactoring generale Casi-d'uso$_G$ esistenti\\
\hline
...
\begin{itemize}
    ...
    \item \textbf{Scenario Principale:} 
        \begin{enumerate}
            ...
            \item Il Sistema$_G$ invia all'utente il messaggio contenente l'annuncio se questo è stato generato.
        \end{enumerate}
     ...
     \item \textbf{Precondizioni:}
      ...
      \item \textbf{Scenario Principale:}
        \begin{enumerate}
            ...
            \item Il Sistema$_G$ riporta  in un panello apposito le informazioni dell'utente in forma tabellare;
...
\begin{itemize}
     ...
     \item \textbf{Precondizioni:}
      ...
      \item \textbf{Scenario Principale:}
        \begin{enumerate}
            \item L'utente privilegiato ha accesso alla Dashboard$_G$ di un singolo utente(UC3);
            \item Il Sistema$_G$ riporta  in un panello apposito le informazioni dell'utente in forma tabellare (UC3.4);
...
\hline
RQ05 & Obbligatorio & È richiesto che il Sistema$_G$ venga testato nella sua interezza tramite Test$_G$ end-to-end, anche non automatizzati.  & Capitolato$_G$\\
\hline
