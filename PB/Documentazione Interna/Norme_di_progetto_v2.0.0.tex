...
\section{Processi di supporto}
    ...
    Devono essere eseguiti per primi visto che le unità garantiscono il corretto funzionamento dei singoli metodi che PoI$_G$ verranno integrati tra di loro.\\
...
\section{Processi organizzativi}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Data di inizio}: data in cui viene iniziato il lavoro descritto dalla issue$_G$;
            \item \textbf{Data di fine}: data in cui viene terminata la issue$_G$.
        \end{itemize}
