...
\subsubsection{MPC01 - Estimated at completion (EAC)}%TODO
...
\subsubsection{MPC05 - Planned Value (PV) \& MPC04 - Earned Value (EV)}%TODO
...
\subsubsection{MPC03 - Actual Cost (AC) \& MPC02 - Estimate to Complete (ETC)}%TODO
...
\subsubsection{MPC08 - Cost Performance Index (CPI)}%TODO
...
\subsubsection{MPC07 - Cost Variance (CV) \& MPC06 - Schedule Variance (SV)}%TODO
...
\subsubsection{MPC10 - Requirements Stability Index (RSI)}%TODO 
...
\subsubsection{MPC16 - Rischi non previsti}%TODO
...
\subsubsection{MPC17 - Efficienza temporale (ET)}%TODO
...
\subsubsection{MPC01 - Errori ortografici}%TODO
...
\subsubsection{MPC11 - Indice Gulpease}%TODO
...
\subsubsection{MPC15 - Metriche di qualità soddisfatte}%TODO
...
\subsubsection{MPC09 - Requisiti Obbligatori Soddisfatti (ROS)}%TODO
