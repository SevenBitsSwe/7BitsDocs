...
\newcommand\version{1.0.5} %aggiunta versione come variabile
...
\begin{tabular}{|c|c|c|c|}
  ...
  \textbf{Metrica} & \textbf{Descrizione} & \textbf{Valore accettazione} & \textbf{Valore ideale}\\
  \hline
  MPD07 & Tempo medio di risposta & $\leq$ 10 secondi & $\leq$ 4 secondi \\
  \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|}
  ...
  \textbf{Metrica} & \textbf{Descrizione} & \textbf{Valore accettazione} & \textbf{Valore ideale}\\
  \hline
  MPD08 & Facilità di utilizzo & $\leq$ 7 click & $\leq$ 5 click\\
  \hline
  MPD09 & Tempo medio di apprendimento & $\leq$ 5 minuti & $\leq$ 2 minuti \\
  \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|}
  ...
  \hline
  MPD10 & Linee di codice per metodo & $\leq$ 50 & $\leq$ 25 \\
  \hline
  MPD11 & Parametri per metodo & $\leq$ 7 & $\leq$ 4 \\
  \hline
  MPD12 & Attributi per classe & $\leq$ 7 & $\leq$ 5 \\
  \hline
  MPD13 & Structure Fan IN & - & va massimizzato \\
  \hline
  MPD14 & Structure Fan OUT & - & va minimizzato \\
  \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|}
  ...
  \textbf{Metrica} & \textbf{Descrizione} & \textbf{Valore accettazione} & \textbf{Valore ideale}\\
  \hline
  MPD15 & Versioni browser supportati & $\geq$ 80\% & 100\% \\
  \hline
\end{tabular}
...
\subsubsection{MPD06 - Branch Coverage}
...
\subsubsection{MPC13 - Line Coverage}
...
\subsection{MPD10 - Linee di codice per metodo}
...
\subsection{MPD11 - Parametri per metodo}
...
\subsection{MPD12 - Attributi per classe}
...
\subsection{MPD13 - Structure Fan IN}
...
\subsection{MPD14 - Structure Fan OUT}
