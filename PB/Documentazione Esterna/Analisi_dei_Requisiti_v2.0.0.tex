...
\rhead{\textcolor[HTML]{9e978a}{ ANALISI DEI REQUISITI v2.0.0}
}
...
\hline
RQ06 & Obbligatorio & I documenti di \textit{Analisi\_dei\_Requisiti\_v1.0.0.pdf} e \textit{Specifica\_Tecnica\_v1.0.0.pdf} dovranno riguardare anche problemi aperti ed eventuali possibili soluzioni da approfondire in futuro.  & Capitolato$_G$\\
\hline
\end{tabular}
...
\begin{itemize} % controllo prima della revisione PB$_G$
