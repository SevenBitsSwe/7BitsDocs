...
\rhead{\textcolor[HTML]{9e978a}{ ANALISI DEI REQUISITI v1.0.3}
}
...
\endhead
\hline
1.0.3 & 2025-03-20 & Federico Pivetta & Uncas Peruzzi & Ultime correzioni agli errori segnalati durante la RTB\\
\hline
...
\hline
RV06 & Obbligatorio & Il sistema deve garantire supporto e fruibilità sulle versioni attuali dei seguenti browser: Chrome/Chromium (vers. 134.0.6998.31), Firefox (vers. 136.0), Safari (vers. 18.3) e Microsoft Edge (vers. 133.0.3065.92). & Capitolato$_G$\\
\hline 
RV07 & Obbligatorio & Il sistema deve avere i seguenti requisiti minimi:
\begin{itemize} % controllo prima della revisione PB
