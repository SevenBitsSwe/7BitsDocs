...
\endhead
    \hline
    0.1.2 & 2025-03-05 & Leonardo Trolese  & Manuel Gusella & Conclusione redazione sottosezione \hyperref[sec:linguaggi]{Panoramica Linguaggi} della sezione Tecnologie\\
    \hline
    0.1.1 & 2025-03-02 & Leonardo Trolese  & Manuel Gusella & Redazione sottosezione \hyperref[sec:linguaggi]{Panoramica Linguaggi} della sezione Tecnologie\\
    \hline
    ...
    \label{sec:linguaggi}
        ...
        Usato come dialetto SQL specifico per l'interazione con il database ClickHouse, un DBMS colonnare ad alte prestazioni.
            \myparagraph{Versione}
                ClickHouse 24.10
            \myparagraph{Documentazione}
                La documentazione può essere trovata qui: \url{https://clickhouse.com/docs/sql-reference} (consultato: 2025-03-05)
            \paragraph{Utilizzo operato nel progetto}
                \begin{itemize}
        ...
        sintassi è basata sull'indentazione e ha una struttura chiave-valore. YAML è spesso usato in file di configurazione.
            \myparagraph{Versione} 
                YAML 1.2
            \myparagraph{Documentazione}
                La documentazione può essere trovata qui: \url{https://yaml.org/spec/1.2.2/} (consultato: 2025-03-05)
            \paragraph{Utilizzo operato nel progetto}
                \begin{itemize}
        ...
        chiave-valore e array. Progettato per essere facilmente leggibile sia dall'uomo che dalle macchine.
            \myparagraph{Versione} 
                JSON 2.0
            \myparagraph{Documentazione}
            La documentazione può essere trovata qui: \url{https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON} (consultato: 2025-03-02)
            \paragraph{Utilizzo operato nel progetto}
                \begin{itemize}
