...
\newcommand\version{0.2.1} %aggiunta versione come variabile
...
\endhead
    \hline
    0.2.2 & 2025-03-29 & Alfredo Rubino & Federico Pivetta & Aggiornamento sezione Design Pattern\\
    \hline
...
\myparagraph{Design Pattern - Factory Pattern}
    ...
    \mysubparagraph{Utilizzo}
    L’integrazione del pattern Adapter disaccoppia la logica specifica della serializzazione e deserializzazione JSON dal codice che la utilizza, rendendo il sistema più modulare ed estensibile. Questa separazione consente di modificare o sostituire le implementazioni senza impattare il resto dell’applicazione. L’Adapter permette di astrarre il processo di conversione dei dati JSON nel formato interno e viceversa, facilitando l’interoperabilità con diversi sistemi e la manutenibilità del codice. Inoltre, questa soluzione si rivela particolarmente utile in scenari in cui l’infrastruttura sottostante potrebbe cambiare, poiché l’aggiornamento può avvenire semplicemente modificando l’Adapter, senza alterare la logica di business principale.
