...
\newcommand\version{1.0.2} %aggiunta versione come variabile
...
Nonostante queste difficoltà, il gruppo è riuscito ad affrontare la prima fase della Revisione Tecnica di Baseline$_G$ (RTB) secondo i piani, garantendo il rispetto degli obiettivi prefissati. La pianificazione dello sprint$_G$ ha tenuto conto delle possibili limitazioni, consentendo di distribuire adeguatamente le attività e assicurare la consegna della documentazione$_G$ richiesta.
    ...
    \newpage
    \subsubsection{Ottavo sprint$_G$}
    \label{ottavo-sprint$_G$}
        ...
        Nel corso dell'ottavo sprint il gruppo si propone di proseguire con lo sviluppo del prodotto MVP, cercare di ultimare il diagramma delle classi e continuare con la readzione di documenti.
        \\
        Il gruppo ha in programma di:
        \begin{itemize}
            ...
            \item Svolgere icontro con professor Cardin per chiarimenti riguardanti la progettazione.
        \end{itemize}
        ...
        Relativamente l'ottava iterazione, dato il prosiguimento nello sviluppo del prodotto MVP, con la conseguente produzione di codice, il gruppo ha identificato dei potenziali rischi in cui potrebbe imbattersi:
        \vspace{-0.5em}
        \begin{itemize}
        \setlength\itemsep{-0.2em}
        \item [-] \hyperref[RT3]{RT3} - Produzione di codice confuso o con errori;
        ...
        Dato l'incremento di ore di lavoro che i vari membri mettono nel progetto, il gruppo è stato in grado di correggere l'errore in tempo e proseguire con lo sviluppo del prodotto$_G$.
        ...
        Di questi 3.324,40€ rappresentano i costi ancora da sostenere per completare il prodotto e la relativa documentazione.\\
        Questo è un buon segnale per il gruppo che fa presagire che la consegna PB stimata per il 2025-04-04 sia un obbiettivo raggiungibile.
