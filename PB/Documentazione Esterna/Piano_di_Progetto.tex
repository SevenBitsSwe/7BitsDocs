...
\endhead
\hline 
1.0.5 & 2025-04-04 & Leonardo Trolese & Manuel Gusella & Inizio redazione undicesimo sprint$_G$ \ref{undicesimo-sprint$_G$}\\\\
\hline 
1.0.4 & 2025-03-28 & Uncas Peruzzi & Federico Pivetta & Redazione decimo sprint$_G$ \ref{decimo-sprint$_G$}\\\\
\hline
...
Nonostante queste difficoltà, il gruppo è riuscito ad affrontare la prima fase della Revisione Tecnica di Baseline$_G$ (RTB) secondo i piani, garantendo il rispetto degli obiettivi prefissati. La pianificazione dello sprint$_G$ ha tenuto conto delle possibili limitazioni, consentendo di distribuire adeguatamente le attività e assicurare la consegna della documentazione$_G$ richiesta.
    ...
    \label{ottavo-sprint$_G$}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                \pie[
                    ...
                    radius=1.5
                ]{3/Responsabile - 3\%, 2/Amministratore - 2\%, 12/Verificatore - 12\%, 37/Progettista - 37\%, 46/Programmatore - 46\%}
            \end{tikzpicture}
        ...
        In base a quanto prodotto fin ora il budget totale stimato per il completamento del progetto è di 12.616,96€, rispetto ai 12.950,00€ inizialmente prestabiliti.
    ...
    \paragraph{Durata sprint}\mbox{}\\
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                \pie[
                    ...
                    radius=1.5
                ]{3/Responsabile - 3\% , 10/Amministratore - 10\%, 2/Analista - 2\%,17/Verificatore - 17\%, 46/Progettista - 46\%, 22/Programmatore - 22\%}
            \end{tikzpicture}
        ...
        In base alle metriche aggiornate al nono sprint, il budget totale stimato per il completamento del progetto è di 12.546,94€, rispetto ai 12.950,00€ inizialmente 
        prestabiliti. Di questa cifra, 1.879,44€ rappresentano i costi ancora da sostenere per completare il prodotto e la relativa documentazione.\\
        ...
        verso le fasi finali del progetto, mantenendo comunque alta l'attenzione sulla qualità del lavoro e sul rispetto delle scadenze.
        ...
        \paragraph{Durata sprint}\mbox{}\\
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}
                    \pie[
                        ...
                        color={responsabile, verificatore, progettista, programmatore, amministratore, analista}, 
                        radius=1.5
                    ]{5/Responsabile - 5\% , 10/Amministratore - 10\%, 10/Analista - 10\%,25/Verificatore - 25\%, 25/Progettista - 25\%, 25/Programmatore - 25\%}
                \end{tikzpicture}
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}
                    \pie[
                        ...
                        color={responsabile, verificatore, progettista, programmatore, amministratore, analista}, 
                        radius=1.5
                    ]{5/Responsabile - 5\%, 9/Amministratore - 9\%, 10/Analista - 10\%, 25/Verificatore - 25\%, 23/Progettista - 23\%, 28/Programmatore - 28\%}
                \end{tikzpicture}
            ...
            Durante il decimo sprint, il gruppo ha notato la fondamentale importanza di adottare una chiara comunicazione tra membri del team, soprattutto durante lo s
            ...
            di rilevanza maggiore. Sono stati inoltre terminati i documenti necessari alla revisione PB con il Professor. Cardin, ed è stata iniziata la redazione 
            ...
            nello specifico il budget stimato per il completamento del progetto è di 12.666,59€, in leggero aumento rispetto allo sprint precedente, ma comunque al di
            ...
            Questo è un indicatore positivo per il gruppo, che può riconfermare la consegna PB del progetto indicativamente per la data 2025-04-04, previa disponibilità 
        ...
        \paragraph{Durata sprint}\mbox{}\\
            ...
            \paragraph{Panoramica generale e obiettivi}\mbox{}\vspace{0.4em}
            Nel corso del decimo sprint, il gruppo si propone di effettuare la verifica conclusiva di tutta la documentazione prodotta o modificata nel corso della 
            seconda fase del progetto, e di fissare e svolgere l'incontro con la proponente Sync Lab per la presentazione del prodotto MVP; oltre che gli incontri di 
            revisione PB con i professori Cardin e Vardanega.\\
            Il gruppo ha in programma di:
            \begin{itemize}
                \item Effettuare la verifica conclusiva della documentazione;
                \item Svolgere l'incontro con la proponente Sync Lab per la presentazione del prodotto MVP;
                \item Svolgere gli incontri di revisione PB con i professori Cardin e Vardanega.
            \end{itemize}
            Segue l'elenco delle attività inserite nel backlog per questa iterazione:
            \vspace{-0.5em}
            \begin{itemize}
            \setlength\itemsep{-0.2em}
                ...
                \item [-] Analisi delle metriche nel documento \textit{Piano\_di\_Progetto};
                \item [-] Correzione glossario;
                \item [-] Presentazione del prodotto MVP alla proponente Sync Lab;
                \item [-] Redazione Presentazione per Product Baseline, revisione Cardin;
                \item [-] Redazione Presentazione per Product Baseline, revisione Vardanega.
            \end{itemize}
            ...
            Relativamente alla undicesima iterazione, il gruppo ha identificato il potenziale rischio dovuto a cambiamenti improvvisi a ridosso della consegna PB (RP3),
            come nel caso del decimo sprint; e il potenziale rischio di incertezza nella stima delle attività (RP2), dovuto principalmente all'impossibilità di 
            ...
            \subparagraph*{Rischi Incontrati}\mbox{}
            Durante la undicesima iterazione il rischio RP3 si è verificato poiché il gruppo ha dovuto apportare delle minimali correzioni al prodotto MVP a seguito 
            dei suggerimenti emersi nell'incontro con la proponente Sync Lab, tuttavia tale rischio non ha comportato ritardi significativi.\\
            Anche il rischio RP2 si è verificato, poiché gli incontri con i professori Cardin e Vardanega hanno rispettato le tempistiche previste per la consegna della 
            documentazione e del prodotto MVP.\\
            
            
            \paragraph{Definizione ruoli}\mbox{}\vspace{0.4em}
            
            Questi sono i ruoli assegnati per membro in questo undicesimo sprint.\\
            \begin{table}[H]
                \centering
                \begin{tabular}{|c|c|}
                \hline
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}
                    \pie[
                        ...
                        color={responsabile, amministratore, analista, verificatore, progettista, programmatore}, 
                        radius=1.5
                    ]{5/Responsabile - 5\% , 0/Amministratore - 0\%, 0/Analista - 0\%, 41/Verificatore - 41\%, 27/Progettista - 27\%, 27/Programmatore - 27\%}
                \end{tikzpicture}
            ...
            % Durante il decimo sprint, il gruppo ha notato la fondamentale importanza di adottare una chiara comunicazione tra membri del team, soprattutto durante lo sviluppo del core del software. Trattandosi di una piccola modifica, non ha intaccato la data di consegna, ma potenzialmente avrebbe potuto creare problemi di rilevanza maggiore. Sono stati inoltre terminati i documenti necessari alla revisione PB con il Professor. Cardin, ed è stata iniziata la redazione della presentazione necessaria al colloquio.
    
            % \subparagraph{Analisi delle strategie di mitigazione adottate}\mbox{}\vspace{0.4em}
            
            % Per mitigare il problema sorto, è stato necessario organizzare una piccola sessione di \textit{peer-to-peer programming} durante la quale i programmatori hanno potuto chiarire e risolvere il problema presente nella business logic senza troppe difficoltà. Questo ha evidenziato come il lavoro sincrono, sebbene più oneroso in termini di tempo e risorse, favorisca una maggiore produttività, in quanto facilita la comunicazione immediata, accelera la risoluzione dei problemi e promuove una collaborazione più stretta tra i membri del team.
