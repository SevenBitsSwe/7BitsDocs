...
Nonostante queste difficoltà, il gruppo è riuscito ad affrontare la prima fase della Revisione Tecnica di Baseline$_G$ (RTB) secondo i piani, garantendo il rispetto degli obiettivi prefissati. La pianificazione dello sprint$_G$ ha tenuto conto delle possibili limitazioni, consentendo di distribuire adeguatamente le attività e assicurare la consegna della documentazione$_G$ richiesta.
    ...
    \paragraph{Durata sprint}\mbox{}\\
        ...
        \paragraph{Durata sprint}\mbox{}\\
            ...
            \paragraph{Panoramica generale e obiettivi}\mbox{}\vspace{0.4em}
            Nel corso del decimo sprint, il gruppo si propone di terminare la codifica del prodotto MVP, inclusi i testi di integrazione e di Sistema. Inoltre dopo aver progettato il diagramma della classi nella sua versione definitiva, l'obiettivo sarà terminare i documenti di Specifica\_Tecnica e Manuale\_Utente per poi preparare la presentazione necessaria alla revisione \textit{PB}.
            Il gruppo ha in programma di:
            \begin{itemize}
            ...
            Per mitigare il problema sorto, è stato necessario organizzare una piccola sessione di \textit{peer-to-peer progamming} dove i programmatori hanno in poche ore, hanno potuto chiarire e risolvere il problema prensente nella business logic senza troppe difficoltà. Questo fa capire che lavorare in maniera sincrona può risultare più costoso in termini di tempo e risorse, ma permette una maggiore produttività, poiché facilita la comunicazione immediata, la risoluzione rapida dei problemi e una più stretta collaborazione tra i membri del team.
