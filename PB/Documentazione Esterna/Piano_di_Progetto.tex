...
\endhead
\hline
1.0.6 & 2025-04-10 & Leonardo Trolese & Manuel Gusella & Fine redazione undicesimo sprint$_G$ \ref{undicesimo-sprint$_G$}\\\\
\hline 
...
Nonostante queste difficoltà, il gruppo è riuscito ad affrontare la prima fase della Revisione Tecnica di Baseline$_G$ (RTB) secondo i piani, garantendo il rispetto degli obiettivi prefissati. La pianificazione dello sprint$_G$ ha tenuto conto delle possibili limitazioni, consentendo di distribuire adeguatamente le attività e assicurare la consegna della documentazione$_G$ richiesta.
    ...
    \paragraph{Durata sprint}\mbox{}\\
        ...
        \paragraph{Durata sprint}\mbox{}\\
            ...
            \paragraph{Retrospettiva}\mbox{}\vspace{0.4em}        
            Nel corso dell'undicesimo sprint il gruppo, si è concentrato sulla produzione di documentazione in preparazione alla revisione PB avvenuta con il professor
            Cardin in data 2025-04-07. Sempre durante questo sprint il gruppo ha anche sostenuto l'incontro di presentazione del prodotto MVP con la proponente Sync Lab,
            durante il quale sono stati presentati e approvati i risultati ottenuti fino a quel momento.\\
            A seguito di entrambi gli incontri c'è infine stato un periodo di conclusione della documentazione, in cui sono stati preparati i documenti necessari per la
            revisione PB del professor Vardanega. Questo periodo ha costretto il gruppo ad allungare la durata dello sprint, e ciò ha confermato l'incorrere del rischio 
            RP2 (incertezza nella stima delle attività) già previsto dal gruppo in fase di pianificazione.\\
    
            \subparagraph{Analisi delle strategie di mitigazione adottate}\mbox{}\vspace{0.4em}
            Il gruppo non ha dovuto mitigare in nessun modo il rischio RP2, poiché i giorni di ritardo registrati non hanno comunque superato la data di ricezione dell'esito
            della revisione PB del professor Cardin. Il gruppo può quindi affermare che tale ritardo non ha avuto alcun impatto sui tempi di consegne previsti.
    
            \subparagraph{Raffinamento delle stime}\mbox{}\vspace{0.4em}
            Il gruppo ha concluso il progetto spendendo un totale di 12.510,00€, a fronte dei 12.950,00€ inizialmente preventivati in fase di redazione del preventivo 
